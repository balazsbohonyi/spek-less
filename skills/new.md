...
Next step: run {{CMD_PREFIX}}spek:discuss to flesh out Context and explore the approach,
or {{CMD_PREFIX}}spek:plan if the feature is simple enough to plan directly.
```
