...
3. Write `<specs_root>/NNN_<slug>/spec.md` with this exact structure (inline, no template substitution needed):
   ...
   <One paragraph: what this task does and why. Derived from the description.>
...
- Next step: `{{CMD_PREFIX}}spek:verify NNN` to confirm, or `{{CMD_PREFIX}}spek:commit NNN` if satisfied
